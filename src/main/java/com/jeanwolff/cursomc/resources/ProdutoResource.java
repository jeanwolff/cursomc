...
import com.jeanwolff.cursomc.dto.ProdutoDTO;
import com.jeanwolff.cursomc.resources.utils.URLUtil;
import com.jeanwolff.cursomc.services.ProdutoService;
...
public class ProdutoResource {
	...
	public ResponseEntity<Page<ProdutoDTO>> findPage(
		...
		List<Integer> ids = URLUtil.decodeIntLis(categorias);
