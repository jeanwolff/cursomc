...
import com.jeanwolff.cursomc.domain.Pagamento;
import com.jeanwolff.cursomc.domain.PagamentoComBoleto;
import com.jeanwolff.cursomc.domain.PagamentoComCartao;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "wolff.jean@live.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "wolff.jean2@live.com", "31227753799", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.addPerfil(Perfil.ADMIN);
		cli2.getTelefones().addAll(Arrays.asList("12345678", "37267862"));

		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);

		Endereco e3 = new Endereco(null, "Rua Ronaldo", "22", null, "Jardim Ronaldo", "38220834", cli2, c1);
